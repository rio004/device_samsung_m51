...
#include <vendor/samsung/hardware/fingerprintextension/1.0/IXiaomiFingerprint.h>
...
#ifdef XIAOMI_FINGERPRINTEXTENSION
using ::vendor::samsung::hardware::fingerprintextension::V1_0::IXiaomiFingerprint;
